...
const SelectProdutoDescontoDetalhe = ({
...
SelectProdutoDescontoDetalhe.propTypes = {
...
SelectProdutoDescontoDetalhe.defaultProps = {
  produto: null,
  setProduto: () => {},
  produtos: [],
  isLoading: false,
...
export default SelectProdutoDescontoDetalhe;
