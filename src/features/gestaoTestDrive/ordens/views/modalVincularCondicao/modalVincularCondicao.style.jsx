...
export const CondicoesDetails = styled.div`
    display: flex;
    flex-direction: column;
    font-size: 0.9rem;
    line-height: 1.4;
...
export const CondicaoColumn = styled.div`
  display: flex;
  flex-direction: column;
  align-items: left;
  text-align: left;
...
export const CondicoesHeaders = styled.div`
  font-weight: 450;
  color: #7C839A;
  font-size: 12px;
  margin-bottom: 2px;
...
export const CondicoesValues = styled.div`
  font-weight: 400;
  color: #505669;
  font-size: 14px;
  overflow: hidden;
