...
import SvgDocument from 'assets/icons/document';
    ...
    <>
      <ClickAwayListener onClickAway={handleClickAway}>
        <Button onClick={handleOnClick} variant="outlined" color="primary500" ref={buttonRef}>
          <SvgDocument style={{ marginRight: '8px' }} fill={colors.primary_color_600} />
      ...
      <PopperComponent anchorEl={anchorEl}>
        <AlertCard
          width="100%"
          title="Já existe uma lista em criação, salve ou apague para adicionar uma nova."
