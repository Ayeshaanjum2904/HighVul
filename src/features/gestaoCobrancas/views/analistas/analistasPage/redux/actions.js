const PREFIX_FILTERS = 'analistasPage/FILTERS';
const SET_MARCA = `${PREFIX_FILTERS}/SET_MARCA`;
const SET_REGIONAL = `${PREFIX_FILTERS}/SET_REGIONAL`;

const PREFIX_GET_ASSOCIACOES = 'analistasPage/GET_ASSOCIACOES';
...
const SET_PAGE = 'analistasPage/SET_PAGE';
const SET_IPP = 'analistasPage/SET_IPP';
const RESET_STORE = 'analistasPage/RESET_STORE';
