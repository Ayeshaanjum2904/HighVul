...
export const MiddleContainer = styled.div`
  ...
  ${(props) => props.isActive && css`
    box-shadow: 0px 0px 1px 0px rgba(0, 0, 0, 0.08), 0px 0px 1px 0px rgba(0, 0, 0, 0.08);
...
export const LeftContainer = styled(MiddleContainer)`
  ...
  border-right: 1px solid ${colors.secundary_color_100};
`;

export const RightContainer = styled(MiddleContainer)`
  border-radius: 0px 4px 4px 0px;
  border-left: 1px solid ${colors.secundary_color_100};
`;
